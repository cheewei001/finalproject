...
class UserManagerDBTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $user = UserManagerDB::getUserByEmailPassword("wong@hotmail.com","Password01");
        $this->assertEquals('Wong',$user->lastname);
    }
    
    public function testGetUserByEmailPasswordinvalid()
    {
        $user = UserManagerDB::getUserByEmailPassword("wong@hotmail.com","Password");
